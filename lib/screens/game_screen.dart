...
import '../widgets/game/word_button.dart';
      ...
      if (hangState == 6) {
        ...
        if (lives < 1) {
          ...
          Alert(
              ...
              context: context,
              title: "Game Over!",
              desc: wordCount>1?"You saved $wordCount clovers":"You saved $wordCount clover",
              buttons: [
                DialogButton(
//                  width: 20,
...
//            desc: "You Lost!",
      ...
      if (hiddenWord == word) {
        ...
        Alert(
          ...
          image: Image.asset('assets/images/4-leaf-clover.png',),
          title: word,
          desc: "You saved a 4 Leaf Clover!",
          buttons: [
            DialogButton(
              radius: BorderRadius.circular(10),
              child: Icon(
